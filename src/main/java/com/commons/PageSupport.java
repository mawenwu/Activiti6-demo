...
public class PageSupport<T> {
     ...
     *            int
     */
    public PageSupport(Collection<T> result, long totalCount) {
        this.result = result;
     ...
     *            String
     */
    public PageSupport(int pageNo, int pageSize, String orderBy, String order) {
        this.pageNo = pageNo;
     ...
     *        int
     */
    public PageSupport(Collection<T> result, int totalCount, int pageSize, int start){
	    this.pageSize = pageSize;
	    this.totalCount = totalCount;
	    this.result = result;
	    this.start = start;
